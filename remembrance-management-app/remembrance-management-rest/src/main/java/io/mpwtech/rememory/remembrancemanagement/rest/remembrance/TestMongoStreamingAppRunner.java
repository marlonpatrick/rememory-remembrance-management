...
public class TestMongoStreamingAppRunner implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) throws Exception {
                ...
                MongoJsonSchema mongoJsonSchema = MongoJsonSchema.builder().property(
                                object("fullDocument").properties(array("outbox").minItems(1)
                                ...
                                // .items(JsonSchemaObject.object().required("_id", "createdAt",
                                // "entityName",
                ...
                ChangeStreamOptions changeStreamOptions = ChangeStreamOptions.builder()
                                .filter(newAggregation(
                                                match(where("operationType").in("insert", "replace",
                                                                "update")),
